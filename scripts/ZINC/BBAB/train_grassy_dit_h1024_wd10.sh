#!/bin/bash
#SBATCH --job-name=BBAB_wd10
#SBATCH --partition=catfish
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=168:00:00
#SBATCH --output=BBAB_wd10_%j.out
#SBATCH --error=BBAB_wd10_%j.err
